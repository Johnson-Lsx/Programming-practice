...
public:
	...
	hfTree1(string* x, int* w, int size);
	~hfTree1() { delete[] elem; }
	void getCode();
...
hfTree1/*<elemType>*/::hfTree1(string* x, int* w, int size)
{
...
void hfTree1/*<elemType>*/:: getCode()
 ...
 int main()
 {
	...
	hfTree1::hfCode* result = new hfTree1::hfCode[len];
	hfTree1 hf(t, w, len);
	hf.getCode();
	hf.getcode(result);
	int sum = 0;
